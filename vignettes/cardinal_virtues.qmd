...
## Justice
 ...
 > Justice concerns two topics: the Population Table and the mathematical formula for the data generating mechanism. The key assumptions underlying the Population Table are validity, stability, representativeness, and unconfoundedness. The primary determinate of the formula is the distribution of the outcome.
