...
### Exercise 10
<!-- AR: What if we replace "key components" with "rows and columns"? I feel like that more clearly connects to the heart of this exercise which is to describe the rows and columns in terms of units, covariates, treatments, and outcomes. Also include "treatments" in words to use? Change in template_tutorial.Rmd? -->
...
<!--AR:  I propose some improved language (with Claude) below for this answer after looking at template tutorial. How does this look? Update template tutorial?-->
```{r justice-8}
```{r justice-8}
question_text(NULL,
...
<!-- AR: fit years has age_lived = sex * age_election instead of age_lived = sex + age_election -->
...
<!-- AR: following code does not work in student's candidates.qmd since they do not yet have `x` -->
...
<!--AR: LaTeX is incorrect for current state of fit_years-->
...
<!-- AR: Mismatch between covariate in the question versus answer message. Which to do? -->
