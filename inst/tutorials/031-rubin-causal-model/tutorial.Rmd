...
<!-- AR: How would the Preceptor Table be populated with data? Shouldn't height data only be available in from the data? -->
...
<!--AR: What's a good example of a ... sourced row? -->
...
<!-- AR: I'm a little confused about having 2040 data in here. -->
...
<!-- AR: Maybe move to the Causal Models section?  -->
...
```{r causal-model-6}
question_text(NULL,
	message = "If different questions or wording of the questions were used, it could result in different outcomes across time.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- AR: Not sure how exposure to spanish speakers over time would vary based on respondent's sex. Instead could reliability of public transit, or crowdedness be a factor? -->
```{r causal-model-7}
question_text(NULL,
...
<!-- AR: This answer is not specific to this problem. Could people naturally exposed to Spanish-speakers on their commute be more likely to speak spanish? If the exposed population had more spanish-speakers (Someone who encounters spanish speakers on their commute may be more likely to speak spanish), then spanish-speaking (and not mere exposure to spanish-speakers) could also underly the difference observed between treatment groups.
```{r causal-model-9}
question_text(NULL,
...
<!-- AR: +1 AC's comment. Shouldn't it be 7.6 (6 + 1.6) instead of 9.4 (11 - 1.6), because Cassidy is a part of the control group. I was a little confused by this question because the treatment outcome is already listed in the table above. -->
