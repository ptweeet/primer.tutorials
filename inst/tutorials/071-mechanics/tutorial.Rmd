...
<!-- AR: Is it possible to make the answers executable r code blocks, so users can easily validate answers? Do for all plotting exercises below. -->
### Exercise 12
...
<!-- AR: instructions for resid_lib do not match formula above. Which is correct? Same issue in Exercise 18 -->
...
<!-- AR: Do not see confidence intervals. Getting the following warning after running this code block: Warning: model3 are not supported models and have been dropped.-->
...
<!-- AR: I was  confused at how to interpret the outputs of this function. What outputs should I focus on and how do I interpret them. -->
