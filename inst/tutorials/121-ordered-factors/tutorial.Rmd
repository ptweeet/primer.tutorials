...
In your last code chunk in ordered.qmd, save the model to the variable `fit_colleges`. Then, in the Console, run `check_predictions(extract_fit_engine(fit_colleges))`. CP/CR.
