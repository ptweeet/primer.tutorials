...
### Exercise 15
<!--AR: How does the scenario, that we are a gubernatorial candidate in Texas, fit in? Should the Preceptor Table not refer to a question that occurs now and relates to that scenario? -->
...
<!--AR: Should the answer relate to the Preceptor Table units from Texas instead of data units from Michigan? -->
```{r justice-10}
question_text(NULL,
