...
### Exercise 5
<!-- AR: I was somewhat confused by the wording of this question. -->
...
```{r justice-3}
question_text(NULL,
	message = "Height can be measured with or without shoes, and it is not clear that NHANES surveyors in 2010 used the same protocol that would be used today. If measurements in the data were taken with shoes on but the `height` column in the Preceptor Table refers to height without shoes, these two columns would not be measuring the same thing.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
### 
<!-- AR: What is the distinction between the data and the population here? Do we see a table for the population? -->
...
### 
<!-- AR: What should the relationship be? What are "the other rows"? -->
...
<!-- AR: Getting a little confused about population vs. Population table. Should population be lower-cased or capitalized, does it depend on whether we're referring to the table? -->
...
<!-- AR: I didn't get a fit_height object at this point. This function does work when run with height_fit (created below) as arg.  -->
...
<!-- AR: Would be really nice to have example answers so we can check our work. -->
### Exercise 7
