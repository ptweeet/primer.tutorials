...
```{r temperance-13}
question_text(NULL,
	message = "The estimates might be wrong because the stability assumption is flawed. If things change a lot between March and November, then the support for Biden might end up much higher or lower than 42%.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
