...
### Exercise 14
<!-- AR: Sex doesn't seem very intuitive to me as a key covariate towards immigration attitudes. Also, this exercise felt like just rephrasing the question. -->
...
```{r temperance-14}
question_text(NULL,
	message = "The estimates might be wrong for several reasons. First, validity may not hold — the `att_end` column measures survey responses, which may not reflect true underlying attitudes toward immigration. Second, the effect may not be stable over time; exposure to Spanish speakers on a train platform in 2012 might have a different effect on attitudes today. For these reasons, we should treat the confidence interval as wider than our model suggests.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
