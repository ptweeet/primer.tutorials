...
Remember that a treatment is just a covariate which, for the purposes of this specific problem, we are assuming can be manipulated, thereby, creating two or more different potential outcomes for each unit.
...
<!-- DK: Change to advice about using make_p_tibble(). -->
